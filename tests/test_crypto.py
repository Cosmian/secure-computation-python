...
def test_sig_and_seal():
    ...
    assert verify(sealed_symkey[64:],
                  sealed_symkey[:64],
                  DP1_ED25519_PUBKEY) == sealed_symkey[64:]

    unsealed_symkey: bytes = unseal(
        sealed_symkey[64:],
        enclave_x25519_sk
    )
...
def test_dalek_sig():
    test_sigs: List[Tuple[bytes, bytes, bytes]] = [
        (CP_SYMKEY,
         bytes.fromhex("9396352cad80c5be7bf7f897dc677770a29f9c9f734efc6e131d73f012e79cc3"
                       "11666810104773d590cbb1aa3a8889bb3bc0d79f5de9525772287da66871f906"),
         CP_ED25519_PUBKEY),
        (DP1_SYMKEY,
         bytes.fromhex("d700eeff0b13ef1d61f9447625d556ae966ac259cb684deb13cb51d427b656ec"
                       "00ae9b57efb0a3a922b316d6356be8ca1876b3f6f982b04172d3dea88ed51e0a"),
         DP1_ED25519_PUBKEY),
        (DP2_SYMKEY,
         bytes.fromhex("33146fb37293a4a30ca209a8ed051e153d1f528e9d40e106567fdd8a16ec7511"
                       "d29e4b0c6e790146643a36fca83c63cc59a274f806be4b5718c1adfebc6a4d0c"),
         DP2_ED25519_PUBKEY),
        (RC_SYMKEY,
         bytes.fromhex("371357b506a5b19e1f616a0c45fd7cbd029d735b07adf95fb913d3db651b65dc"
